...
def loadPiCamCameraModel ():
	...
	# LOADING MATRICES:
	# -------------------------------------------------------------
	thetaY = 59*DEGTORAD # considerando que la camara (en vertical) esta rotada 90º sobre eje Y
	thetaZ = 0*DEGTORAD # considerando que la camara (en vertical) esta rotada 90º sobre eje Y
	thetaX = 0*DEGTORAD # considerando que la camara (en vertical) esta rotada 90º sobre eje Y
